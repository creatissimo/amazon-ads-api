...
final class SBBrandedKeywordsPricingMultiStatusResponse
{
    ...
    /** @return SBBrandedKeywordsPricingMultiStatusSuccess[] */
    public function getSuccess(): array
    {
        return $this->success;
    }

    /** @param SBBrandedKeywordsPricingMultiStatusSuccess[] $success */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            success: array_map(
                static fn(array $v) => SBBrandedKeywordsPricingMultiStatusSuccess::fromArray($v),
                $data['success'] ?? [],
            ),
        );
    }
