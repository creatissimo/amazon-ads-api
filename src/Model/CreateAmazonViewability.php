...
final class CreateAmazonViewability
{
    public function __construct(
        private bool $includeUnmeasurableImpressions,
    ...
    {
        return new self(
            includeUnmeasurableImpressions: (bool) $data['includeUnmeasurableImpressions'],
            viewabilityTier: ViewabilityTier::from($data['viewabilityTier']),
        );
    }
}
