...
final class AdNameFilter
{
    public function __construct(
        private array $include,
        private AdNameFilterType $queryTermMatchType,
    ) {
    }
    ...
    public function setQueryTermMatchType(AdNameFilterType $queryTermMatchType): self
    {
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            queryTermMatchType: AdNameFilterType::from($data['queryTermMatchType']),
        );
    }
}
