...
final class CreateBidSettings
{
    public function __construct(
        private ?CreateBidAdjustments $bidAdjustments = null,
    ...
    public function setBidAdjustments(?CreateBidAdjustments $bidAdjustments): self
    {
    ...
    {
        return new self(
            bidAdjustments: isset($data['bidAdjustments']) ? CreateBidAdjustments::fromArray($data['bidAdjustments']) : null,
